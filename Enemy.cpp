...
void EnemyImage()
{
	...
	vol_UFO_width = DxLib::LoadSoundMem(L"./Data/Sounds/shush.mp3");
	if (vol_UFO_width == -1)
	{
		DxPlus::Utils::FatalError(L"./Data/Sounds/shush.mp3");
	}

	vol_UFO_height = DxLib::LoadSoundMem(L"./Data/Sounds/cancel.mp3");
	if (vol_UFO_height == -1)
	{
		DxPlus::Utils::FatalError(L"./Data/Sounds/cancel.mp3");
	}
	//音
